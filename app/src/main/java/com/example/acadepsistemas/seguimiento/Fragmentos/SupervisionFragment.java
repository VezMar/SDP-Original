 ...
 * {@link SupervisionFragment.OnFragmentInteractionListener} interface
 * to handle interaction events.
 * Use the {@link SupervisionFragment#newInstance} factory method to
...
public class SupervisionFragment extends Fragment {
     ...
     * @return A new instance of fragment SupervisionFragment.
     */
    // TODO: Rename and change types and number of parameters
    public static SupervisionFragment newInstance(String param1, String param2) {
       ...
       /* bottomNavigationView = (BottomNavigationView) view.findViewById(R.id.bottomNavigationView);
        bottomNavigationView.setOnNavigationItemSelectedListener(new BottomNavigationView.OnNavigationItemSelectedListener() {
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem menuItem) {
                ...
                } else if(menuItem.getItemId() == R.id.itemDurante){

                } else if(menuItem.getItemId() == R.id.itemDespues){
